...
describe('List Box Tests', function () {
    ...
    qase([40],
    it('should visit the web and click on the List Box Link', function() {
        home.visit();
        home.isReady();
        home.closePopUp();
    ...
    qase([41],
    it('should visit the web and click on the Jquery List Link', function() {
        home.visit();
        home.isReady();
        home.closePopUp();
    ...
    qase([42],
    it('should visit the web and click on the Data List Filter Link', function() {
        home.visit();
        home.isReady();
        home.closePopUp();
